...
&& [ -f /etc/apache2/mods-available/php5.load ] && [ -f /usr/bin/php5 ]; then
	...
	echo "Downloading Visual apache2."
	wget http://binary-sequence.github.com/webapp-visual-apache2/downloads/visual-apache2-1.0.tar.gz
